...
var FileService = function () {
    ...
    var FileService = _classThis = /** @class */ (function () {
        function FileService_1() {
        }
        FileService_1.prototype.ensureDir = function (path) {
        ...
        FileService_1.prototype.readTextFile = function (path) {
            return __awaiter(this, void 0, void 0, function () {
                var error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        FileService_1.prototype.writeTextFile = function (path, content) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ensureDir(path)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, fs_1.promises.writeFile(path, content)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        FileService_1.prototype.readDir = function (path) {
            return __awaiter(this, void 0, void 0, function () {
                var error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
